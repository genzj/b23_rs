...
- **Internationalization:** Translation dictionaries (JSON) are embedded into the Rust binary at compile time and dynamically injected into the frontend HTML based on user preference or browser headers.
